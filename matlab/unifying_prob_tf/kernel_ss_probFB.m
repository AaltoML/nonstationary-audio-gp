...
%     [lik,Xfin,Pfin] = kernel_ss_kalmanSlowFB_cheap(A,Q,C,P0,K,vary,y,verbose,KF);
else
    [lik,Xfin,Pfin] = kernel_ss_kalmanFastFB(A,Q,C,P0,K,vary,y,verbose,KF);
end
