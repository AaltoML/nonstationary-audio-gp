function KL = GetKLPY(varx1,varc1,mux1,varx2,varc2,mux2,Opts) 
  ...
  y = linspace(yLower,yUpper,NumYs)';
  ...
  KL = sum(exp(logPY1).*(logPY1-logPY2))*dy*dz;

  if sum(exp(logPY1))*dy*dz<0.9
