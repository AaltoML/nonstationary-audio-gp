function [varargout] = likModulatorPreCalcwn(link, hyp, y, mu, s2, W, ep_fraction, wn, xn_unscaled, inf, i)
...
if nargin<10                              % prediction mode if inf is not present
  ...
  case 'infEP'   
    if nargin<11                                             % no derivative mode
